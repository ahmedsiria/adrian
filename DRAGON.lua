...
if res ~= 200 then
print('\27[0;31m≪━━━━━━𝐒𝐎𝐔𝐑𝐂𝐄 𝐀D𝐑𝐘𝐀𝐍𖥤 ☬━━━━━━≫\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na≪━━━━━━𝐒𝐎𝐔𝐑𝐂𝐄 𝐀D𝐑𝐘𝐀𝐍𖥤 ☬━━━━━━≫\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m≪━━━━━━𝐒𝐎𝐔𝐑𝐂𝐄 𝐀D𝐑𝐘𝐀𝐍𖥤 ☬━━━━━━≫ ━\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
echo "≪━━━━━━𝐒𝐎𝐔𝐑𝐂𝐄 𝐀D𝐑𝐘𝐀𝐍𖥤 ☬━━━━━━≫ ≪━━━━━━𝐒𝐎𝐔𝐑𝐂𝐄 𝐀D𝐑𝐘𝐀𝐍𖥤 ☬━━━━━━≫ ━"
exit 1
fi
if [ ! $token ]; then
echo "≪━━━━━━𝐒𝐎𝐔𝐑𝐂𝐄 𝐀D𝐑𝐘𝐀𝐍𖥤 ☬━━━━━━≫ ≪━━━━━━𝐒𝐎𝐔𝐑𝐂𝐄 𝐀D𝐑𝐘𝐀𝐍𖥤 ☬━━━━━━≫ ━ ━"
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/ahmedsiria/taiger/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1726705278,1671048315,1153223737}   
...
if tonumber(user_id) == tonumber(1681991286) then  
var = true  
elseif tonumber(user_id) == tonumber(1671048315) then
var = true
elseif tonumber(user_id) == tonumber(1153223737) then
var = true
...
local UserName = (data.username_ or "Source_AdrYan")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𝐒𝐎𝐔𝐑𝐂𝐄 𝐀D𝐑𝐘𝐀𝐍𖥤 ☬.")  
...
os.execute('wget https://raw.githubusercontent.com/ahmedsiria/taiger/main/DRAGON.lua')
...
usertext = '\n ⏎︙ العضو » ['..result.title_..'](t.me/'..(username or 'Source_AdrYan')..')'
status  = '\n ⏎︙ تم ترقيته مطور'
...
usertext = '\n ⏎︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Source_AdrYan')..')'
status  = '\n ⏎︙ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⏎︙ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Source_AdrYan')..') \n ⏎︙ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
{{text = 'قناة السورس', url="t.me/Source_AdrYan"}}, 
{{text = 'Group _آلـ๋͜‏ـعـ๋͜‏ـيـ๋͜‏ـلـ๋͜‏ـۿۿہ𖡬', url="t.me/Leaking72"}}, 
{{text = ' 𝐀D𝐑𝐘𝐀𝐍𖥤', url="t.me/Leaking51"}}, 
} 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ⏎︙ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Source_AdrYan')..') \n ⏎︙ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⏎︙ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Source_AdrYan')..') \n ⏎︙ تـم قفـل التاك بالكتم ')
end,nil)   
...
if tonumber(result.sender_user_id_) == tonumber(1671048315) then  
...
if result.id_ == tonumber(1671048315) then
...
if tonumber(userid) == tonumber(1671048315) then  
send(msg.chat_id_, msg.id_, " ⏎︙ لا تسطيع حظر مطور السورس عام")
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ⏎︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Source_AdrYan')..')'
status  = '\n ⏎︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ⏎︙ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ⏎︙ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Source_AdrYan')..')'
...
' }\n'..' ⏎︙  الايدي بالصوره » { '..idph..
' }\n'..' ⏎︙  الرفع » { '..setadd..
' }\n'..' ⏎︙  الحظر » { '..banm..' }\n\n≪━━━━━━𝐒𝐎𝐔𝐑𝐂𝐄 𝐀D𝐑𝐘𝐀𝐍𖥤 ☬━━━━━━≫\n ⏎︙ قناة سورس سوريا ↓\n [🖨┇𝐒𝐎𝐔𝐑𝐂𝐄 𝐀D𝐑𝐘𝐀𝐍𖥤 ☬.](t.me/Source_AdrYan) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ⏎︙ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'Source_AdrYan')..')'..'\n ⏎︙ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
database:set(bot_id.."Source_AdrYan:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."Source_AdrYan:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."Source_AdrYan:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."Source_AdrYan:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"⏎︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."Source_AdrYan:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."Source_AdrYan:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'Source_AdrYan')..')'
local iduser = result.sender_user_id_
...
{
{text = '☉ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐀D𝐑𝐘𝐀𝐍𖥤 ☬ ☉', url="t.me/Source_AdrYan"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
sendAudio(msg.chat_id_,msg.id_,'./'..msg.sender_user_id_..'.mp3','@Source_AdrYan','•غنيلي = اغاني عشوائيه اهداء من البوت•','end')
