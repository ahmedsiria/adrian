...
sudo_users = {SUDO,1806598497,1754365642,1364212456,1854618934,1840926402,1885944409}   
...
if tonumber(user_id) == tonumber(1806598497) then  
var = true 
...
{
{text = 'ＳＯＵＲＣＥ ＳＩＲＩＡ ', url="t.me/X_G_33"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id='..msg.chat_id_..'&caption='..URL.escape(Name)..'&photo='..taha.photos_[0].sizes_[1].photo_.persistent_id_..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
...
local Text = [[
مطورين ومبرمجين سورس سوريا اتبع الازرار للتواصل معهم ⬇️🧿
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'عموري مطور السورس',url="t.me/Dv_69"}},
{{text = 'سوريا مبرمج السورس',url="t.me/siria100"}},
{{text = 'كساحه مطور السورس',url="t.me/MR_AAS"}},
}
local msg_id = msg.id_/2097152/0.5
...
t = ' ✹ ملفات السورس سوريا𖤍━┅┄⟞⟦᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣⟧⟝┄┉━𖤍\n 𖤍━┅┄⟞⟦᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣⟧⟝┄┉━𖤍 \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
local function getpro(extra, result, success)
if result.photos_[0] then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_,"~انت~"..Rutba(msg.sender_user_id_,msg.chat_id_).." ✹روح قلبي 🥺❤️", msg.id_, msg.id_, "md")
else
